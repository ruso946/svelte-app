 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xc=Pp;function Jc(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const s=Object.assign({name:Xr,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw xt.create("bad-app-name",{appName:String(i)});if(n||(n=Of()),!n)throw xt.create("no-options");const r=yi.get(i);if(r){if(Gr(n,r.options)&&Gr(s,r.config))return r;throw xt.create("duplicate-app",{appName:i})}const o=new jf(i);for(const l of Jr.values())o.addComponent(l);const a=new Lp(n,s,o);return yi.set(i,a),a}function Zc(t=Xr){const e=yi.get(t);if(!e&&t===Xr)return Jc();if(!e)throw xt.create("no-app",{appName:t});return e}function Ft(t,e,n){var s;let i=(s=Np[t])!==null&&s!==void 0?s:t;n&&(i+=`-${n}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${i}" with version "${e}":`];r&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),on.warn(a.join(" "));return}fs(new On(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bp=1024,Vp=30*24*60*60*1e3;class Up{constructor(e){this.container=e,this._heartbeatsCache=null;const n=this.container.getProvider("app").getImmediate();this._storage=new jp(n),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){const n=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=sl();if(this._heartbeatsCache===null&&(this._heartbeatsCache=await this._heartbeatsCachePromise),!(this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(i=>i.date===s)))return this._heartbeatsCache.heartbeats.push({date:s,agent:n}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(i=>{const r=new Date(i.date).valueOf();return Date.now()-r<=Vp}),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache===null||this._heartbeatsCache.heartbeats.length===0)return"";const e=sl(),{heartbeatsToSend:n,unsentEntries:s}=$p(this._heartbeatsCache.heartbeats),i=mi(JSON.stringify({version:2,heartbeats:n}));return this._heartbeatsCache.lastSentHeartbeatDate=e,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}}function sl(){return new Date().toISOString().substring(0,10)}function $p(t,e=Bp){const n=[];let s=t.slice();for(const i of t){const r=n.find(o=>o.agent===i.agent);if(r){if(r.dates.push(i.date),il(n)>e){r.dates.pop();break}}else if(n.push({agent:i.agent,dates:[i.date]}),il(n)>e){n.pop();break}s=s.slice(1)}return{heartbeatsToSend:n,unsentEntries:s}}class jp{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Lf()?Mf().then(()=>!0).catch(()=>!1):!1}async read(){return await this._canUseIndexedDBPromise?await Fp(this.app)||{heartbeats:[]}:{heartbeats:[]}}async overwrite(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return nl(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var n;if(await this._canUseIndexedDBPromise){const i=await this.read();return nl(this.app,{lastSentHeartbeatDate:(n=e.lastSentHeartbeatDate)!==null&&n!==void 0?n:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function il(t){return mi(JSON.stringify({version:2,heartbeats:t})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Be{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(s){try{return atob(s)}catch(i){throw i instanceof DOMException?new um("Invalid base64 string: "+i):i}}(e);return new Be(n)}static fromUint8Array(e){const n=function(s){let i="";for(let r=0;r<s.length;++r)i+=String.fromCharCode(s[r]);return i}(e);return new Be(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return e=this.binaryString,btoa(e);var e}toUint8Array(){return function(e){const n=new Uint8Array(e.length);for(let s=0;s<e.length;s++)n[s]=e.charCodeAt(s);return n}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return te(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}Be.EMPTY_BYTE_STRING=new Be("");const hm=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function jt(t){if(re(!!t),typeof t=="string"){let e=0;const n=hm.exec(t);if(re(!!n),n[1]){let i=n[1];i=(i+"000000000").substr(0,9),e=Number(i)}const s=new Date(t);return{seconds:Math.floor(s.getTime()/1e3),nanos:e}}return{seconds:pe(t.seconds),nanos:pe(t.nanos)}}function pe(t){return typeof t=="number"?t:typeof t=="string"?Number(t):0}function Mn(t){return typeof t=="string"?Be.fromBase64String(t):Be.fromUint8Array(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ah(t){var e,n;return((n=(((e=t==null?void 0:t.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function lh(t){const e=t.mapValue.fields.__previous_value__;return ah(e)?lh(e):e}function _s(t){const e=jt(t.mapValue.fields.__local_write_time__.timestampValue);return new ve(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Id="firebasestorage.googleapis.com",Vv="storageBucket",Uv=2*60*1e3,$v=10*60*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
If you think this parameter should be updatable, request it here: https://github.com/sweetalert2/sweetalert2/issues/new?template=02_feature_request.md`)}),e};function N0(){const t=z.domCache.get(this),e=z.innerParams.get(this);if(!e){tf(this);return}t.popup&&K.swalCloseEventFinishedCallback&&(K.swalCloseEventFinishedCallback(),delete K.swalCloseEventFinishedCallback),K.deferDisposalTimer&&(clearTimeout(K.deferDisposalTimer),delete K.deferDisposalTimer),typeof e.didDestroy=="function"&&e.didDestroy(),O0(this)}const O0=t=>{tf(t),delete t.params,delete K.keydownHandler,delete K.keydownTarget,delete K.currentInstance},tf=t=>{t.isAwaitingPromise()?(Hr(z,t),z.awaitingPromise.set(t,!0)):(Hr(As,t),Hr(z,t))},Hr=(t,e)=>{for(const n in t)t[n].delete(e)},nf=Object.freeze(Object.defineProperty({__proto__:null,_destroy:N0,close:oi,closeModal:oi,closePopup:oi,closeToast:oi,disableButtons:T0,disableInput:S0,disableLoading:hc,enableButtons:_0,enableInput:C0,getInput:i0,getProgressSteps:k0,handleAwaitingPromise:Xs,hideLoading:hc,isAwaitingPromise:m0,rejectPromise:v0,resetValidationMessage:A0,showValidationMessage:I0,update:D0},Symbol.toStringTag,{value:"Module"})),R0=t=>{const e=z.innerParams.get(t);t.disableButtons(),e.input?sf(t,"confirm"):Ka(t,!0)},L0=t=>{const e=z.innerParams.get(t);t.disableButtons(),e.returnInputValueOnDeny?sf(t,"deny"):Ha(t,!1)},M0=(t,e)=>{t.disableButtons(),e(Qn.cancel)},sf=(t,e)=>{const n=z.innerParams.get(t);if(!n.input)return gn(`The "input" parameter is needed to be set when using returnInputValueOn${La(e)}`);const s=Yb(t,n);n.inputValidator?x0(t,s,e):t.getInput().checkValidity()?e==="deny"?Ha(t,s):Ka(t,s):(t.enableButtons(),t.showValidationMessage(n.validationMessage))},x0=(t,e,n)=>{const s=z.innerParams.get(t);t.disableInput(),Promise.resolve().then(()=>zs(s.inputValidator(e,s.validationMessage))).then(r=>{t.enableButtons(),t.enableInput(),r?t.showValidationMessage(r):n==="deny"?Ha(t,e):Ka(t,e)})},Ha=(t,e)=>{const n=z.innerParams.get(t||globalThis);n.showLoaderOnDeny&&$n(Kt()),n.preDeny?(z.awaitingPromise.set(t||globalThis,!0),Promise.resolve().then(()=>zs(n.preDeny(e,n.validationMessage))).then(i=>{i===!1?(t.hideLoading(),Xs(t)):t.closePopup({isDenied:!0,value:typeof i>"u"?e:i})}).catch(i=>rf(t||globalThis,i))):t.closePopup({isDenied:!0,value:e})},fc=(t,e)=>{t.closePopup({isConfirmed:!0,value:e})},rf=(t,e)=>{t.rejectPromise(e)},Ka=(t,e)=>{const n=z.innerParams.get(t||globalThis);n.showLoaderOnConfirm&&$n(),n.preConfirm?(t.resetValidationMessage(),z.awaitingPromise.set(t||globalThis,!0),Promise.resolve().then(()=>zs(n.preConfirm(e,n.validationMessage))).then(i=>{Je(vr())||i===!1?(t.hideLoading(),Xs(t)):fc(t,typeof i>"u"?e:i)}).catch(i=>rf(t||globalThis,i))):fc(t,e)},F0=(t,e,n)=>{z.innerParams.get(t).toast?B0(t,e,n):(U0(e),$0(e),j0(t,e,n))},B0=(t,e,n)=>{e.popup.onclick=()=>{const s=z.innerParams.get(t);s&&(V0(s)||s.timer||s.input)||n(Qn.close)}},V0=t=>t.showConfirmButton||t.showDenyButton||t.showCancelButton||t.showCloseButton;let xi=!1;const U0=t=>{t.popup.onmousedown=()=>{t.container.onmouseup=function(e){t.container.onmouseup=void 0,e.target===t.container&&(xi=!0)}}},$0=t=>{t.container.onmousedown=()=>{t.popup.onmouseup=function(e){t.popup.onmouseup=void 0,(e.target===t.popup||t.popup.contains(e.target))&&(xi=!0)}}},j0=(t,e,n)=>{e.container.onclick=s=>{const i=z.innerParams.get(t);if(xi){xi=!1;return}s.target===e.container&&yr(i.allowOutsideClick)&&n(Qn.backdrop)}},q0=t=>typeof t=="object"&&t.jquery,pc=t=>t instanceof Element||q0(t),H0=t=>{const e={};return typeof t[0]=="object"&&!pc(t[0])?Object.assign(e,t[0]):["title","html","icon"].forEach((n,s)=>{const i=t[s];typeof i=="string"||pc(i)?e[n]=i:i!==void 0&&gn(`Unexpected type of ${n}! Expected "string" or "Element", got ${typeof i}`)}),e};function K0(...t){const e=this;return new e(...t)}function z0(t){class e extends this{_main(s,i){return super._main(s,Object.assign({},t,i))}}return e}const G0=()=>K.timeout&&K.timeout.getTimerLeft(),of=()=>{if(K.timeout)return Lw(),K.timeout.stop()},af=()=>{if(K.timeout){const t=K.timeout.start();return $a(t),t}},W0=()=>{const t=K.timeout;return t&&(t.running?of():af())},Q0=t=>{if(K.timeout){const e=K.timeout.increase(t);return $a(e,!0),e}},Y0=()=>K.timeout&&K.timeout.isRunning();let gc=!1;const No={};function X0(t="data-swal-template"){No[t]=this,gc||(document.body.addEventListener("click",J0),gc=!0)}const J0=t=>{for(let e=t.target;e&&e!==document;e=e.parentNode)for(const n in No){const s=e.getAttribute(n);if(s){No[n].fire({template:s});return}}},Z0=Object.freeze(Object.defineProperty({__proto__:null,argsToParams:H0,bindClickHandler:X0,clickCancel:a0,clickConfirm:Qd,clickDeny:o0,enableLoading:$n,fire:K0,getActions:Qs,getCancelButton:cn,getCloseButton:Fa,getConfirmButton:ht,getContainer:Ve,getDenyButton:Kt,getFocusableElements:Ba,getFooter:Bd,getHtmlContainer:Mi,getIcon:Ws,getImage:xd,getInputLabel:Dw,getLoader:Wn,getPopup:ne,getTimerLeft:G0,getTimerProgressBar:wr,getTitle:Md,getValidationMessage:vr,increaseTimer:Q0,isDeprecatedParameter:ko,isLoading:Nw,isTimerRunning:Y0,isUpdatableParameter:Rd,isValidParameter:Od,isVisible:r0,mixin:z0,resumeTimer:af,showLoading:$n,stopTimer:of,toggleTimer:W0},Symbol.toStringTag,{value:"Module"}));let Oo;class Yn{constructor(...e){if(typeof window>"u")return;Oo=this;const n=Object.freeze(this.constructor.argsToParams(e));Object.defineProperties(this,{params:{value:n,writable:!1,enumerable:!0,configurable:!0}});const s=this._main(this.params);z.promise.set(this,s)}_main(e,n={}){Aw(Object.assign({},n,e)),K.currentInstance&&(K.currentInstance._destroy(),Va()&&Kd()),K.currentInstance=this;const s=tE(e,n);Rb(s),Object.freeze(s),K.timeout&&(K.timeout.stop(),delete K.timeout),clearTimeout(K.restoreFocusTimeout);const i=nE(this);return Hd(this,s),z.innerParams.set(this,s),eE(this,i,s)}then(e){return z.promise.get(this).then(e)}finally(e){return z.promise.get(this).finally(e)}}const eE=(t,e,n)=>new Promise((s,i)=>{const r=o=>{t.closePopup({isDismissed:!0,dismiss:o})};As.swalPromiseResolve.set(t,s),As.swalPromiseReject.set(t,i),e.confirmButton.onclick=()=>R0(t),e.denyButton.onclick=()=>L0(t),e.cancelButton.onclick=()=>M0(t,r),e.closeButton.onclick=()=>r(Qn.close),F0(t,e,r),l0(t,K,n,r),Qb(t,n),Hb(n),sE(K,n,r),iE(e,n),setTimeout(()=>{e.container.scrollTop=0})}),tE=(t,e)=>{const n=Tb(t),s=Object.assign({},Pn,e,n,t);return s.showClass=Object.assign({},Pn.showClass,s.showClass),s.hideClass=Object.assign({},Pn.hideClass,s.hideClass),s},nE=t=>{const e={popup:ne(),container:Ve(),actions:Qs(),confirmButton:ht(),denyButton:Kt(),cancelButton:cn(),loader:Wn(),closeButton:Fa(),validationMessage:vr(),progressSteps:Fd()};return z.domCache.set(t,e),e},sE=(t,e,n)=>{const s=wr();Ue(s),e.timer&&(t.timeout=new Lb(()=>{n("timer"),delete t.timeout},e.timer),e.timerProgressBar&&(De(s),ot(s,e,"timerProgressBar"),setTimeout(()=>{t.timeout&&t.timeout.running&&$a(e.timer)})))},iE=(t,e)=>{if(!e.toast){if(!yr(e.allowEnterKey))return oE();rE(t,e)||Po(e,-1,1)}},rE=(t,e)=>e.focusDeny&&Je(t.denyButton)?(t.denyButton.focus(),!0):e.focusCancel&&Je(t.cancelButton)?(t.cancelButton.focus(),!0):e.focusConfirm&&Je(t.confirmButton)?(t.confirmButton.focus(),!0):!1,oE=()=>{document.activeElement instanceof HTMLElement&&typeof document.activeElement.blur=="function"&&document.activeElement.blur()};Object.assign(Yn.prototype,nf);Object.assign(Yn,Z0);Object.keys(nf).forEach(t=>{Yn[t]=function(...e){if(Oo)return Oo[t](...e)}});Yn.DismissReason=Qn;Yn.version="11.4.8";const ks=Yn;ks.default=ks;const bn=[];function _r(t,e=ye){let n;const s=new Set;function i(a){if(bt(t,a)&&(t=a,n)){const l=!bn.length;for(const c of s)c[1](),bn.push(c,t);if(l){for(let c=0;c<bn.length;c+=2)bn[c][0](bn[c+1]);bn.length=0}}}function r(a){i(a(t))}function o(a,l=ye){const c=[a,l];return s.add(c),s.size===1&&(n=e(i)||ye),a(t),()=>{s.delete(c),s.size===0&&n&&(n(),n=null)}}return{set:i,update:r,subscribe:o}}const Kr=_r({nombre:"nombreDefault",apellido:"apellidoDefault",id:"idDefault",plan:"planDefault",nroSocio:9876543210}),Ro=_r(""),Lo=_r(""),fi=_r(""),aE=(t,e)=>{t.forEach(n=>{e.forEach(s=>{s in n||(n[s]=null)})})},lE=async t=>{try{await Ra(Ct(Ae,"Pacientes",t.id),t)}catch(e){console.log(e)}};function mc(t,e,n){const s=t.slice();return s[9]=e[n],s[11]=n,s}function yc(t){let e,n,s=t[0],i=[];for(let r=0;r<s.length;r+=1)i[r]=vc(mc(t,s,r));return{c(){e=T("div"),n=T("ul");for(let r=0;r<i.length;r+=1)i[r].c();p(n,"class","sinPunto svelte-1uycqnr"),p(e,"class","listadoPacientes svelte-1uycqnr")},m(r,o){X(r,e,o),v(e,n);for(let a=0;a<i.length;a+=1)i[a]&&i[a].m(n,null)},p(r,o){if(o&7){s=r[0];let a;for(a=0;a<s.length;a+=1){const l=mc(r,s,a);i[a]?i[a].p(l,o):(i[a]=vc(l),i[a].c(),i[a].m(n,null))}for(;a<i.length;a+=1)i[a].d(1);i.length=s.length}},d(r){r&&Q(e),Ds(i,r)}}}function vc(t){let e,n,s,i,r,o=`${t[9].apellido}, ${t[9].nombre}`.slice(0,20).padEnd(21," ")+`${t[9].plan=="particular"?"":t[9].nroSocio+"   plan "+t[9].plan.plan}`,a,l,c,u,h,d;return u=Lc(t[5][0]),{c(){e=T("li"),n=T("input"),i=j(),r=T("label"),a=se(o),c=j(),p(n,"type","radio"),p(n,"id",s=t[9].id),p(n,"name","pacientes"),n.__value=t[11],n.value=n.__value,p(r,"for",l=t[9].id),u.p(n)},m(f,g){X(f,e,g),v(e,n),n.checked=n.__value===t[1],v(e,i),v(e,r),v(r,a),v(e,c),h||(d=[Z(n,"change",t[4]),Z(n,"change",t[2])],h=!0)},p(f,g){g&1&&s!==(s=f[9].id)&&p(n,"id",s),g&3&&(n.checked=n.__value===f[1]),g&1&&o!==(o=`${f[9].apellido}, ${f[9].nombre}`.slice(0,20).padEnd(21," ")+`${f[9].plan=="particular"?"":f[9].nroSocio+"   plan "+f[9].plan.plan}`)&&je(a,o),g&1&&l!==(l=f[9].id)&&p(r,"for",l)},d(f){f&&Q(e),u.r(),h=!1,tt(d)}}}function cE(t){let e,n=t[0].length>0&&yc(t);return{c(){n&&n.c(),e=Rc()},m(s,i){n&&n.m(s,i),X(s,e,i)},p(s,[i]){s[0].length>0?n?n.p(s,i):(n=yc(s),n.c(),n.m(e.parentNode,e)):n&&(n.d(1),n=null)},i:ye,o:ye,d(s){n&&n.d(s),s&&Q(e)}}}function uE(t,e,n){let{pacientesFiltrada:s}=e,{planSelect:i}=e,r=0,o;const a=Fi(),l=h=>{const d=h.target.value;n(3,i=s[d].plan),o=s[d].id,a("cambioSelectPaciente",[d,i,o]),console.log(`dispatch cambioSelectPaciente, idPaciente ${o} valorindiceSelectPaciente: 
      ${d}, planSelect ${i.plan?i.plan:"particular"}`)},c=[[]];function u(){r=this.__value,n(1,r)}return t.$$set=h=>{"pacientesFiltrada"in h&&n(0,s=h.pacientesFiltrada),"planSelect"in h&&n(3,i=h.planSelect)},[s,r,l,i,u,c]}class hE extends Rt{constructor(e){super(),Ot(this,e,uE,cE,bt,{pacientesFiltrada:0,planSelect:3})}}function dE(t){let e,n,s,i,r,o,a,l,c,u,h,d,f,g,m,w,I,b,C,P,L,B,V,k,M,x,ce,le,dt,G,ie,Ne,ft,Ke,mn,_t,yn,pt,S,me,he,R,de,$e;return L=new hE({props:{pacientesFiltrada:t[3],planSelect:fE}}),L.$on("cambioSelectPaciente",t[15]),he=new _f({props:{planes:t[1],planSeleccionado:t[0],SelectPlanVisible:t[6],indicePlan:t[5]}}),he.$on("cambioPlan",t[14]),he.$on("clickCheckPlan",t[16]),{c(){e=T("body"),n=T("div"),s=T("div"),i=T("button"),r=se("create"),a=j(),l=T("button"),c=se("update"),h=j(),d=T("button"),f=se("delete"),m=j(),w=T("div"),I=T("label"),I.textContent="filtrar por apellido",b=T("input"),C=j(),P=T("div"),Ut(L.$$.fragment),B=j(),V=T("div"),k=T("label"),k.textContent="nombre",M=T("input"),x=j(),ce=T("label"),ce.textContent="apellido",le=T("input"),dt=j(),G=T("div"),ie=T("label"),ie.textContent="nº socio",Ne=j(),ft=T("div"),Ke=T("input"),mn=j(),_t=T("button"),_t.textContent="✎",yn=j(),pt=T("label"),S=se(t[10]),me=j(),Ut(he.$$.fragment),i.disabled=o=!t[7]||!t[8]||!t[0]||!t[9],p(i,"class","svelte-40mbgp"),l.disabled=u=!t[7]||!t[8]||!t[0]||!t[9]||!t[4],p(l,"class","svelte-40mbgp"),d.disabled=g=!t[4],p(d,"class","svelte-40mbgp"),p(s,"class","buttons svelte-40mbgp"),p(n,"id","botones"),p(n,"class","svelte-40mbgp"),p(I,"for","filterPrefix"),p(I,"class","svelte-40mbgp"),p(b,"name","filterPrefix"),p(b,"id","filterPrefix"),p(b,"placeholder","filter prefix"),p(b,"class","svelte-40mbgp"),p(w,"id","filter"),p(w,"class","svelte-40mbgp"),p(P,"id","selectPacientes"),p(P,"class","svelte-40mbgp"),p(k,"for","nombre"),p(k,"class","svelte-40mbgp"),p(M,"name","nombre"),p(M,"id","nombre"),p(M,"placeholder","nombre"),p(M,"class","svelte-40mbgp"),p(ce,"for","apellido"),p(ce,"class","svelte-40mbgp"),p(le,"name","apellido"),p(le,"id","apellido"),p(le,"placeholder","apellido"),p(le,"class","svelte-40mbgp"),p(V,"id","formInputsI"),p(V,"class","svelte-40mbgp"),p(ie,"for","inputNroSocio"),p(ie,"class","svelte-40mbgp"),p(Ke,"id","inputNroSocio"),p(Ke,"name","nroSocio"),p(Ke,"placeholder","nro de Socio"),p(Ke,"class","svelte-40mbgp"),p(_t,"class","svelte-40mbgp"),p(ft,"class","formRow svelte-40mbgp"),p(pt,"id","labelPlan"),p(pt,"for","plan"),p(pt,"class","svelte-40mbgp"),p(G,"id","formInputsD"),p(G,"class","svelte-40mbgp"),p(e,"class","svelte-40mbgp")},m($,Ce){X($,e,Ce),v(e,n),v(n,s),v(s,i),v(i,r),v(s,a),v(s,l),v(l,c),v(s,h),v(s,d),v(d,f),v(e,m),v(e,w),v(w,I),v(w,b),_e(b,t[2]),v(e,C),v(e,P),It(L,P,null),v(e,B),v(e,V),v(V,k),v(V,M),_e(M,t[7]),v(V,x),v(V,ce),v(V,le),_e(le,t[8]),v(e,dt),v(e,G),v(G,ie),v(G,Ne),v(G,ft),v(ft,Ke),_e(Ke,t[9]),v(ft,mn),v(ft,_t),v(G,yn),v(G,pt),v(pt,S),v(G,me),It(he,G,null),R=!0,de||($e=[Z(i,"click",t[11]),Z(l,"click",t[12]),Z(d,"click",t[13]),Z(b,"input",t[21]),Z(M,"input",t[22]),Z(le,"input",t[23]),Z(Ke,"input",t[24]),Z(_t,"click",pE)],de=!0)},p($,Ce){(!R||Ce[0]&897&&o!==(o=!$[7]||!$[8]||!$[0]||!$[9]))&&(i.disabled=o),(!R||Ce[0]&913&&u!==(u=!$[7]||!$[8]||!$[0]||!$[9]||!$[4]))&&(l.disabled=u),(!R||Ce[0]&16&&g!==(g=!$[4]))&&(d.disabled=g),Ce[0]&4&&b.value!==$[2]&&_e(b,$[2]);const Ye={};Ce[0]&8&&(Ye.pacientesFiltrada=$[3]),L.$set(Ye),Ce[0]&128&&M.value!==$[7]&&_e(M,$[7]),Ce[0]&256&&le.value!==$[8]&&_e(le,$[8]),Ce[0]&512&&Ke.value!==$[9]&&_e(Ke,$[9]),(!R||Ce[0]&1024)&&je(S,$[10]);const Se={};Ce[0]&2&&(Se.planes=$[1]),Ce[0]&1&&(Se.planSeleccionado=$[0]),Ce[0]&64&&(Se.SelectPlanVisible=$[6]),Ce[0]&32&&(Se.indicePlan=$[5]),he.$set(Se)},i($){R||(We(L.$$.fragment,$),We(he.$$.fragment,$),R=!0)},o($){rt(L.$$.fragment,$),rt(he.$$.fragment,$),R=!1},d($){$&&Q(e),At(L),At(he),de=!1,tt($e)}}}let fE="particular";function pE(t){const e=document.getElementById("inputNroSocio");console.log(`input ${e}`),e.select(),e.setSelectionRange(0,99999),document.execCommand("copy")}function gE(t,e,n){let s,i,r,o,a;Jt(t,fi,S=>n(25,i=S)),Jt(t,Kr,S=>n(26,r=S)),Jt(t,Lo,S=>n(27,o=S)),Jt(t,Ro,S=>n(28,a=S));let{pacientes:l=[]}=e,{sesiones:c}=e,{planes:u}=e,{planSeleccionado:h}=e,d=["nombre","apellido","nroSocio","plan","createdAt"],{optionsPlan:f}=e,g,m=0,w;Fc(()=>{aE(l,d),l.forEach(S=>{lE(S)}),console.log(a)});let I="",b="",C="",P="",L=[],B="plan";vn(Kr,r=s,r);const V=S=>{n(7,b=S?S.nombre:""),n(8,C=S?S.apellido:""),n(9,P=S?S.nroSocio:""),n(0,h=S?S.plan:{})},k=async()=>{try{await Sd(nt(Ae,"Pacientes"),{nombre:b,apellido:C,nroSocio:P,createdAt:new Date().toLocaleDateString(),plan:h}),Dn({text:"Nuevo paciente agregado"}).showToast()}catch(S){console.error(S)}},M=()=>{n(17,l=l.concat({nombre:b,apellido:C})),n(20,m=l.length-1),k(),n(7,b=n(8,C=n(0,h=n(9,P=""))))},x=async S=>{try{await Ra(Ct(Ae,"Pacientes",S.id),S),Dn({text:`paciente ${S.apellido}, ${S.nombre} actualizado`,style:{background:"linear-gradient(to right, #00b09b, #96c93d)"}}).showToast()}catch(me){console.error(me)}},ce=()=>{n(4,s.nombre=b,s),n(4,s.apellido=C,s),n(0,h=s.plan),n(4,s.nroSocio=P,s),n(4,s),n(3,L),n(20,m),n(2,I),n(17,l),n(17,l),x(s)},le=async S=>{try{await Ao(Ct(Ae,"Pacientes",S.id)),Dn({text:"Paciente eliminado",style:{background:"red"}}).showToast()}catch(he){console.error(he)}const me=ls(nt(Ae,"sesiones"),Io("pacienteID","==",S.id));console.log(`desde delete q=pacientes a borrar ${me} - paciente: ${S.nombre} ${S.apellido} ${S.id}`);try{(await Cd(me)).forEach(R=>{Ao(R.ref)})}catch(he){console.log(he)}},dt=()=>{const S=l.indexOf(s);ks.fire({title:"Are you sure?",text:"You won't be able to revert this!",icon:"warning",showCancelButton:!0,confirmButtonColor:"#3085d6",cancelButtonColor:"#d33",confirmButtonText:"Yes, delete it!"}).then(me=>{me.isConfirmed&&(ks.fire("Deleted!","Your file has been deleted.","success"),le(l[m]),n(17,l=[...l.slice(0,S),...l.slice(S+1)]),n(7,b=n(8,C=n(9,P=n(0,h="")))),n(20,m=Math.min(m,L.length-2)))})},G=S=>{n(4,s.plan=S,s),n(4,s.nombre=b,s),n(4,s.apellido=C,s),n(4,s.nroSocio=P,s),n(3,L[m].plan=S,L),x(s)},ie=S=>{n(0,h=S.detail),console.log(h),s.plan.plan!=h.plan&&G(h)},Ne=S=>{S?(n(10,B="particular"),n(6,w=!1)):(n(10,B="plan"),n(6,w=!0))},ft=S=>{n(20,m=S.detail[0]);const me=S.detail[1];vn(fi,i=S.detail[2],i);const he=typeof me=="string"?"particular":me.plan;console.log(`i ${m}, planSelect ${he}`),n(0,h=he=="particular"?"particular":L[m].plan),h!="particular"&&(n(5,g=u.findIndex(de=>de.plan===he)),console.log(`indicePlan ${g}, ${typeof g}`));const R=he=="particular";Ne(R)},Ke=S=>{const me=S.detail.valor.SelectPlanVisible;me?me&&h=="particular"&&n(0,h="210"):n(0,h="particular"),G(h),Ne(!me)};function mn(){I=this.value,n(2,I)}function _t(){b=this.value,n(7,b)}function yn(){C=this.value,n(8,C)}function pt(){P=this.value,n(9,P)}return t.$$set=S=>{"pacientes"in S&&n(17,l=S.pacientes),"sesiones"in S&&n(18,c=S.sesiones),"planes"in S&&n(1,u=S.planes),"planSeleccionado"in S&&n(0,h=S.planSeleccionado),"optionsPlan"in S&&n(19,f=S.optionsPlan)},t.$$.update=()=>{t.$$.dirty[0]&131076&&n(3,L=I?l.filter(S=>`${S.apellido}, ${S.nombre}`.toLowerCase().startsWith(I.toLowerCase())):l.map(S=>({nombre:S.nombre,apellido:S.apellido,plan:S.plan,nroSocio:S.nroSocio,id:S.id}))),t.$$.dirty[0]&1048584&&n(4,s=L[m]),t.$$.dirty[0]&16&&s&&(vn(Kr,r=s,r),vn(Ro,a=s.apellido,a),vn(Lo,o=s.nombre,o),vn(fi,i=s.id,i)),t.$$.dirty[0]&16&&V(s)},[h,u,I,L,s,g,w,b,C,P,B,M,ce,dt,ie,ft,Ke,l,c,f,m,mn,_t,yn,pt]}class mE extends Rt{constructor(e){super(),Ot(this,e,gE,dE,bt,{pacientes:17,sesiones:18,planes:1,planSeleccionado:0,optionsPlan:19},null,[-1,-1])}}const yE=nt(Ae,"sesiones");nt(Ae,"Pacientes");nt(Ae,"Planes");const vE=async t=>{const e=li(t),n=e.fechaInicio,s=e.fechaFin;try{return(await Cd(ls(yE,Io("diaSesion",">=",n),Io("diaSesion","<=",s)))).docs.map(r=>r.data())}catch(i){console.error(i)}};function wc(t,e,n){const s=t.slice();return s[6]=e[n],s}function bc(t){let e,n=`listar mes de ${t[6].nombre} - ${t[6].nro.toString().padStart(2,"0")}`,s;return{c(){e=T("option"),s=se(n),e.__value=t[6].nro,e.value=e.__value},m(i,r){X(i,e,r),v(e,s)},p:ye,d(i){i&&Q(e)}}}function wE(t){let e,n,s,i=t[1],r=[];for(let o=0;o<i.length;o+=1)r[o]=bc(wc(t,i,o));return{c(){e=T("select");for(let o=0;o<r.length;o+=1)r[o].c();p(e,"name","mes"),p(e,"id","mesRegistro"),t[0]===void 0&&ds(()=>t[4].call(e))},m(o,a){X(o,e,a);for(let l=0;l<r.length;l+=1)r[l]&&r[l].m(e,null);gi(e,t[0]),n||(s=[Z(e,"change",t[3]),Z(e,"change",t[4])],n=!0)},p(o,[a]){if(a&2){i=o[1];let l;for(l=0;l<i.length;l+=1){const c=wc(o,i,l);r[l]?r[l].p(c,a):(r[l]=bc(c),r[l].c(),r[l].m(e,null))}for(;l<r.length;l+=1)r[l].d(1);r.length=i.length}a&3&&gi(e,o[0])},i:ye,o:ye,d(o){o&&Q(e),Ds(r,o),n=!1,tt(s)}}}function bE(t,e,n){let s=new Date().getMonth()+1,i=[{nro:1,nombre:"enero"},{nro:2,nombre:"febrero"},{nro:3,nombre:"marzo"},{nro:4,nombre:"abri"},{nro:5,nombre:"mayo"},{nro:6,nombre:"junio"},{nro:7,nombre:"julio"},{nro:8,nombre:"agosto"},{nro:9,nombre:"setiembre"},{nro:10,nombre:"octubre"},{nro:11,nombre:"noviembre"},{nro:12,nombre:"diciembre"}];const r=Fi(),o=c=>{r("cambioMes",c)},a=c=>o(c.target.value);function l(){s=Mc(this),n(0,s),n(1,i)}return[s,i,o,a,l]}class EE extends Rt{constructor(e){super(),Ot(this,e,bE,wE,bt,{})}}function Ec(t,e,n){const s=t.slice();return s[10]=e[n],s[12]=n,s}function _c(t){let e,n,s,i,r,o,a,l,c,u,h=t[2](t[1]).totalColPagos+"",d,f,g,m,w=t[2](t[1]).totalColValorSesion+"",I,b,C,P,L,B=t[1],V=[];for(let k=0;k<B.length;k+=1)V[k]=Tc(Ec(t,B,k));return{c(){e=T("button"),e.textContent="Cerrar",n=j(),s=T("div"),i=T("table"),r=T("tr"),r.innerHTML=`<th class="svelte-s1hkz6">n°</th> 
                    ...
                    <th class="svelte-s1hkz6">pago</th>`,o=j(),a=T("tbody");for(let k=0;k<V.length;k+=1)V[k].c();l=j(),c=T("p"),u=se("Total pagos: $"),d=se(h),f=j(),g=T("p"),m=se("Total valor sesion: $"),I=se(w),b=j(),C=T("button"),C.textContent="Cerrar",p(r,"class","svelte-s1hkz6"),p(a,"class","svelte-s1hkz6"),p(i,"class","svelte-s1hkz6"),p(s,"id","tabla"),p(s,"class","svelte-s1hkz6"),p(c,"class","centrar svelte-s1hkz6"),p(g,"class","centrar svelte-s1hkz6")},m(k,M){X(k,e,M),X(k,n,M),X(k,s,M),v(s,i),v(i,r),v(i,o),v(i,a);for(let x=0;x<V.length;x+=1)V[x]&&V[x].m(a,null);X(k,l,M),X(k,c,M),v(c,u),v(c,d),X(k,f,M),X(k,g,M),v(g,m),v(g,I),X(k,b,M),X(k,C,M),P||(L=[Z(e,"click",t[6]),Z(C,"click",t[7])],P=!0)},p(k,M){if(M&2){B=k[1];let x;for(x=0;x<B.length;x+=1){const ce=Ec(k,B,x);V[x]?V[x].p(ce,M):(V[x]=Tc(ce),V[x].c(),V[x].m(a,null))}for(;x<V.length;x+=1)V[x].d(1);V.length=B.length}M&2&&h!==(h=k[2](k[1]).totalColPagos+"")&&je(d,h),M&2&&w!==(w=k[2](k[1]).totalColValorSesion+"")&&je(I,w)},d(k){k&&Q(e),k&&Q(n),k&&Q(s),Ds(V,k),k&&Q(l),k&&Q(c),k&&Q(f),k&&Q(g),k&&Q(b),k&&Q(C),P=!1,tt(L)}}}function Tc(t){let e,n,s,i,r,o=`${Cc(t[10].diaSesion.slice(8,10),2,!1)}`,a,l,c,u=`${t[10].apellido}, ${t[10].nombre}`,h,d,f,g=t[10].plan.slice(0,4)+"",m,w,I,b=t[10].valorPago+"",C,P,L,B=t[10].valorSesion+"",V,k;return{c(){e=T("tr"),n=T("td"),s=se(t[12]),i=j(),r=T("td"),a=se(o),l=j(),c=T("td"),h=se(u),d=j(),f=T("td"),m=se(g),w=j(),I=T("td"),C=se(b),P=j(),L=T("td"),V=se(B),k=j(),p(n,"class","svelte-s1hkz6"),p(r,"class","dia svelte-s1hkz6"),p(c,"class","nombre svelte-s1hkz6"),p(f,"class","plan svelte-s1hkz6"),p(I,"class","svelte-s1hkz6"),p(L,"class","svelte-s1hkz6"),p(e,"class","svelte-s1hkz6")},m(M,x){X(M,e,x),v(e,n),v(n,s),v(e,i),v(e,r),v(r,a),v(e,l),v(e,c),v(c,h),v(e,d),v(e,f),v(f,m),v(e,w),v(e,I),v(I,C),v(e,P),v(e,L),v(L,V),v(e,k)},p(M,x){x&2&&o!==(o=`${Cc(M[10].diaSesion.slice(8,10),2,!1)}`)&&je(a,o),x&2&&u!==(u=`${M[10].apellido}, ${M[10].nombre}`)&&je(h,u),x&2&&g!==(g=M[10].plan.slice(0,4)+"")&&je(m,g),x&2&&b!==(b=M[10].valorPago+"")&&je(C,b),x&2&&B!==(B=M[10].valorSesion+"")&&je(V,B)},d(M){M&&Q(e)}}}function _E(t){let e,n,s,i;e=new EE({}),e.$on("cambioMes",t[5]);let r=t[0]&&t[1].length>0&&_c(t);return{c(){Ut(e.$$.fragment),n=j(),s=T("div"),r&&r.c(),p(s,"class","listadoSesionesPorMes svelte-s1hkz6")},m(o,a){It(e,o,a),X(o,n,a),X(o,s,a),r&&r.m(s,null),i=!0},p(o,[a]){o[0]&&o[1].length>0?r?r.p(o,a):(r=_c(o),r.c(),r.m(s,null)):r&&(r.d(1),r=null)},i(o){i||(We(e.$$.fragment,o),i=!0)},o(o){rt(e.$$.fragment,o),i=!1},d(o){At(e,o),o&&Q(n),o&&Q(s),r&&r.d()}}}function Cc(t,e,n){let s=String(t);return s.length>e?s=s.slice(0,e):s.length<e&&n?s=s.padStart(e,"_"):s.length<e&&!n&&(s=s.padEnd(e,"_")),s}function TE(t,e,n){let{mesSeleccionado:s}=e,{vistaCalculos:i}=e,{arrayParaLaVista:r}=e;const o=Fi(),a=f=>{var g=0,m=0;return f.forEach(w=>{g+=w.valorPago,m+=w.valorSesion}),{totalColPagos:g,totalColValorSesion:m}},l=f=>{i==!1?(o("vistaPulsado",f),n(4,s=f),n(0,i=!i)):(o("vistaPulsado",f),n(4,s=f)),console.log(a(r),`mes: ${s}, cant de sesiones: ${r.length}`)},c=f=>{n(4,s=f),l(f)},u=f=>c(f.detail),h=()=>n(0,i=!i),d=()=>n(0,i=!i);return t.$$set=f=>{"mesSeleccionado"in f&&n(4,s=f.mesSeleccionado),"vistaCalculos"in f&&n(0,i=f.vistaCalculos),"arrayParaLaVista"in f&&n(1,r=f.arrayParaLaVista)},[i,r,a,c,s,u,h,d]}class CE extends Rt{constructor(e){super(),Ot(this,e,TE,_E,bt,{mesSeleccionado:4,vistaCalculos:0,arrayParaLaVista:1})}}function SE(t){let e,n,s;return{c(){e=T("p"),n=se("total por paciente: "),s=se(t[0])},m(i,r){X(i,e,r),v(e,n),v(e,s)},p(i,[r]){r&1&&je(s,i[0])},i:ye,o:ye,d(i){i&&Q(e)}}}function IE(t,e,n){let{varSumaValorPagoPorPaciente:s}=e;return t.$$set=i=>{"varSumaValorPagoPorPaciente"in i&&n(0,s=i.varSumaValorPagoPorPaciente)},[s]}class AE extends Rt{constructor(e){super(),Ot(this,e,IE,SE,bt,{varSumaValorPagoPorPaciente:0})}}function Sc(t,e,n){const s=t.slice();return s[46]=e[n],s}function Ic(t){let e,n,s=`Mes: ${t[7]}`,i,r,o,a,l,c,u,h,d,f,g,m=t[12]&&t[13]&&Ac(t),w=t[0],I=[];for(let b=0;b<w.length;b+=1)I[b]=Dc(Sc(t,w,b));return u=new AE({props:{varSumaValorPagoPorPaciente:t[6]}}),f=new CE({props:{vistaCalculos:t[4],arrayParaLaVista:t[5],mesSeleccionado:t[7]}}),f.$on("vistaPulsado",t[25]),{c(){e=T("div"),n=T("h5"),i=se(s),r=j(),m&&m.c(),o=j(),a=T("div"),l=T("ul");for(let b=0;b<I.length;b+=1)I[b].c();c=j(),Ut(u.$$.fragment),h=j(),d=T("div"),Ut(f.$$.fragment),p(n,"class","svelte-fsn5g3"),p(e,"class","tituloSelectorSesiones svelte-fsn5g3"),p(l,"class","sinPunto svelte-fsn5g3"),p(a,"class","selectorSesiones svelte-fsn5g3"),p(d,"class","svelte-fsn5g3")},m(b,C){X(b,e,C),v(e,n),v(n,i),v(e,r),m&&m.m(e,null),X(b,o,C),X(b,a,C),v(a,l);for(let P=0;P<I.length;P+=1)I[P]&&I[P].m(l,null);v(a,c),It(u,a,null),X(b,h,C),X(b,d,C),It(f,d,null),g=!0},p(b,C){if((!g||C[0]&128)&&s!==(s=`Mes: ${b[7]}`)&&je(i,s),b[12]&&b[13]?m?m.p(b,C):(m=Ac(b),m.c(),m.m(e,null)):m&&(m.d(1),m=null),C[0]&16523){w=b[0];let B;for(B=0;B<w.length;B+=1){const V=Sc(b,w,B);I[B]?I[B].p(V,C):(I[B]=Dc(V),I[B].c(),I[B].m(l,null))}for(;B<I.length;B+=1)I[B].d(1);I.length=w.length}const P={};C[0]&64&&(P.varSumaValorPagoPorPaciente=b[6]),u.$set(P);const L={};C[0]&16&&(L.vistaCalculos=b[4]),C[0]&32&&(L.arrayParaLaVista=b[5]),C[0]&128&&(L.mesSeleccionado=b[7]),f.$set(L)},i(b){g||(We(u.$$.fragment,b),We(f.$$.fragment,b),g=!0)},o(b){rt(u.$$.fragment,b),rt(f.$$.fragment,b),g=!1},d(b){b&&Q(e),m&&m.d(),b&&Q(o),b&&Q(a),Ds(I,b),At(u),b&&Q(h),b&&Q(d),At(f)}}}function Ac(t){let e,n,s,i,r;return{c(){e=T("p"),n=se("Paciente: "),s=se(t[12]),i=se(", "),r=se(t[13]),p(e,"class","svelte-fsn5g3")},m(o,a){X(o,e,a),v(e,n),v(e,s),v(e,i),v(e,r)},p(o,a){a[0]&4096&&je(s,o[12]),a[0]&8192&&je(r,o[13])},d(o){o&&Q(e)}}}function kc(t){let e,n,s,i,r=!1,o,a,l=`${t[46].diaSesion.slice(8,10)} -sesion: $${t[46].valorSesion}-pago: ${t[46].fechaPago.slice(5,10)} $${t[46].valorPago}`,c,u,h,d,f,g;return d=Lc(t[24][0]),{c(){e=T("li"),n=T("input"),o=j(),a=T("label"),c=se(l),h=j(),p(n,"type","radio"),p(n,"id",s=t[46].id),p(n,"name","sesiones"),n.__value=i=t[46].id,n.value=n.__value,p(n,"class","svelte-fsn5g3"),p(a,"for",u=t[46].id),p(a,"class","svelte-fsn5g3"),p(e,"class","svelte-fsn5g3"),d.p(n)},m(m,w){X(m,e,w),v(e,n),n.checked=n.__value===t[1],v(e,o),v(e,a),v(a,c),v(e,h),f||(g=[Z(n,"change",t[14]),Z(n,"change",t[23])],f=!0)},p(m,w){w[0]&1&&s!==(s=m[46].id)&&p(n,"id",s),w[0]&1&&i!==(i=m[46].id)&&(n.__value=i,n.value=n.__value,r=!0),(r||w[0]&3)&&(n.checked=n.__value===m[1]),w[0]&1&&l!==(l=`${m[46].diaSesion.slice(8,10)} -sesion: $${m[46].valorSesion}-pago: ${m[46].fechaPago.slice(5,10)} $${m[46].valorPago}`)&&je(c,l),w[0]&1&&u!==(u=m[46].id)&&p(a,"for",u)},d(m){m&&Q(e),d.r(),f=!1,tt(g)}}}function Dc(t){let e=Object.values(t[46]).includes(t[3])&&parseInt(t[46].diaSesion.slice(5,7))==t[7],n,s=e&&kc(t);return{c(){s&&s.c(),n=Rc()},m(i,r){s&&s.m(i,r),X(i,n,r)},p(i,r){r[0]&137&&(e=Object.values(i[46]).includes(i[3])&&parseInt(i[46].diaSesion.slice(5,7))==i[7]),e?s?s.p(i,r):(s=kc(i),s.c(),s.m(n.parentNode,n)):s&&(s.d(1),s=null)},d(i){s&&s.d(i),i&&Q(n)}}}function kE(t){let e,n,s,i,r,o,a,l,c,u,h,d,f,g,m,w,I,b,C,P,L,B,V,k,M,x,ce,le,dt,G=t[0].length>0&&Ic(t);return{c(){e=T("main"),n=T("body"),G&&G.c(),s=j(),i=T("div"),r=T("form"),o=T("div"),a=T("div"),l=T("label"),l.textContent="pago",c=T("input"),u=j(),h=T("label"),h.textContent="valor sesion",d=T("input"),f=j(),g=T("div"),m=T("label"),m.textContent="Dia Sesion",w=T("input"),I=j(),b=T("label"),b.textContent="Fecha Pago",C=T("input"),P=j(),L=T("div"),B=T("button"),B.textContent="update",V=j(),k=T("button"),k.textContent="delete",M=j(),x=T("button"),x.textContent="Agregar sesión",p(l,"for","valorPago"),p(l,"class","svelte-fsn5g3"),p(c,"name","valorPago"),p(c,"id","valorPago"),p(c,"type","number"),p(c,"step","100"),p(c,"min","0"),p(c,"placeholder","Valor pago"),p(c,"class","svelte-fsn5g3"),p(h,"for","valorSesion"),p(h,"class","svelte-fsn5g3"),p(d,"name","valorSesion"),p(d,"id","valorSesion"),p(d,"type","number"),p(d,"step","100"),p(d,"min","0"),p(d,"placeholder","Valor sesión"),p(d,"class","svelte-fsn5g3"),p(a,"id","inputsFormSesionesI"),p(a,"class","svelte-fsn5g3"),p(m,"for","diaSesion"),p(m,"class","svelte-fsn5g3"),p(w,"name","diaSesion"),p(w,"id","diaSesion"),p(w,"type","date"),p(w,"placeholder","Día sesión"),p(w,"class","svelte-fsn5g3"),p(b,"for","fechaPago"),p(b,"class","svelte-fsn5g3"),p(C,"name","fechaPago"),p(C,"id","fechaPago"),p(C,"type","date"),p(C,"placeholder","Fecha pago"),p(C,"class","svelte-fsn5g3"),p(g,"id","inputsFormSesionesD"),p(g,"class","svelte-fsn5g3"),p(B,"class","svelte-fsn5g3"),p(k,"class","svelte-fsn5g3"),p(x,"class","svelte-fsn5g3"),p(L,"id","botonesFormSesiones"),p(L,"class","buttons svelte-fsn5g3"),p(o,"id","form-Sesiones"),p(o,"class","svelte-fsn5g3"),p(r,"class","svelte-fsn5g3"),p(i,"id","contenedor-form-sesiones"),p(i,"class","svelte-fsn5g3"),p(n,"class","svelte-fsn5g3"),p(e,"class","svelte-fsn5g3")},m(ie,Ne){X(ie,e,Ne),v(e,n),G&&G.m(n,null),v(n,s),v(n,i),v(i,r),v(r,o),v(o,a),v(a,l),v(a,c),_e(c,t[8]),v(a,u),v(a,h),v(a,d),_e(d,t[9]),v(o,f),v(o,g),v(g,m),v(g,w),_e(w,t[10]),v(g,I),v(g,b),v(g,C),_e(C,t[11]),v(o,P),v(o,L),v(L,B),v(L,V),v(L,k),v(L,M),v(L,x),ce=!0,le||(dt=[Z(c,"input",t[26]),Z(d,"input",t[27]),Z(w,"input",t[28]),Z(C,"input",t[29]),Z(B,"click",t[30]),Z(k,"click",t[31]),Z(x,"click",t[15]),Z(r,"submit",uf(t[22]))],le=!0)},p(ie,Ne){ie[0].length>0?G?(G.p(ie,Ne),Ne[0]&1&&We(G,1)):(G=Ic(ie),G.c(),We(G,1),G.m(n,s)):G&&(Vc(),rt(G,1,1,()=>{G=null}),Uc()),Ne[0]&256&&pi(c.value)!==ie[8]&&_e(c,ie[8]),Ne[0]&512&&pi(d.value)!==ie[9]&&_e(d,ie[9]),Ne[0]&1024&&_e(w,ie[10]),Ne[0]&2048&&_e(C,ie[11])},i(ie){ce||(We(G),ce=!0)},o(ie){rt(G),ce=!1},d(ie){ie&&Q(e),G&&G.d(),le=!1,tt(dt)}}}function DE(t,e,n){let s,i,r;Jt(t,fi,R=>n(3,s=R)),Jt(t,Ro,R=>n(12,i=R)),Jt(t,Lo,R=>n(13,r=R));let{sesiones:o}=e,{pacientes:a}=e,{planes:l}=e,{planSeleccionado:c}=e,u=!1,h=[],d,f=0;const g=new Date;let m=g.getMonth()+1,w=g.getFullYear(),I=m;console.log(`mesSeleccionado ${I}`);let b,C,P=0;const L=R=>{if(n(1,b=R.target.value),console.log(o),n(2,C=o.find($e=>$e.id===b)),console.log("selectedSession",C),n(8,M=C.valorPago),console.log(`planSeleccionado: ${c}`),typeof c.plan>"u"||c.plan=="particular"||!c)n(9,x=C.valorSesion),console.log("particular",x);else{var de=l.find($e=>$e.plan==c);console.log(de),console.log("OS",x)}n(11,le=C.fechaPago),n(10,ce=C.diaSesion)},B=async()=>{console.log("Add sesion",C);try{const R=await Sd(nt(Ae,"sesiones"),{valorPago:M,valorSesion:x,diaSesion:ce,fechaPago:le,pacienteID:s});console.log("sesion agregada"),Dn({text:"Nueva sesion agregada"}).showToast(),n(1,b=R.id)}catch(R){console.error(R)}},V=async R=>{console.log("Update sesion",R);try{await Ra(Ct(Ae,"sesiones",R.id),{valorPago:M,valorSesion:x,fechaPago:le,diaSesion:ce}),Dn({text:"sesion actualizada",style:{background:"linear-gradient(to right, #00b09b, #96c93d)"}}).showToast()}catch(de){console.log(de)}},k=async R=>{console.log("Delete sesion",R);try{await Ao(Ct(Ae,"sesiones",R.id)),Dn({text:"Sesion eliminada",style:{background:"red"}}).showToast()}catch(de){console.error(de)}};let M=5e3,x=5e3,ce=new Date().toISOString().slice(0,10),le=new Date().toISOString().slice(0,10);m.toString().padStart(2,"0"),w.toString();let dt=R=>o.filter($e=>$e.pacienteID===R&&$e.diaSesion.slice(5,7)===I.toString().padStart(2,"0")).reduce(($e,$)=>$e+$.valorSesion,0);const G=async R=>{n(7,I=R);const de=await ie(I);n(5,h=de[1]),console.log(Array.isArray(de[1])),console.log(de[1]),n(4,u=!0)},ie=async R=>{R||(R=m);try{const de=await vE(R);P=0,f=0;let $e=[];return de.forEach($=>{let Ce=$.pacienteID;const Ye=a.find(Xn=>Xn.id==Ce);var Se=$.valorPago;if(Se==null&&(Se=0),typeof Se=="number")if(Ye.plan=="particular"){P+=Se,Se<x&&(f+=x-Se);var Tr={diaSesion:$.diaSesion,apellido:Ye.apellido,nombre:Ye.nombre,plan:Ye.plan.plan?Ye.plan.plan:"particular",valorPago:Se,valorSesion:$.valorSesion};$e.push(Tr)}else{const Xn=Ye.plan;var Tr={diaSesion:$.diaSesion,apellido:Ye.apellido,nombre:Ye.nombre,plan:Ye.plan.plan?Ye.plan.plan:"particular",valorPago:Se,valorSesion:$.valorSesion};$e.push(Tr),Se<Xn.valorCoseguro&&(f+=Xn.valorCoseguro-Se),P+=Xn.valorOs+Se}}),n(6,d=dt(s)),[P,$e]}catch(de){return console.error("Error al obtener las sesiones y los pagos:",de),[]}},Ne=[[]];function ft(R){pf.call(this,t,R)}function Ke(){b=this.__value,n(1,b)}const mn=async R=>G(R.detail);function _t(){M=pi(this.value),n(8,M)}function yn(){x=pi(this.value),n(9,x)}function pt(){ce=this.value,n(10,ce)}function S(){le=this.value,n(11,le)}const me=()=>V(C),he=()=>k(C);return t.$$set=R=>{"sesiones"in R&&n(0,o=R.sesiones),"pacientes"in R&&n(19,a=R.pacientes),"planes"in R&&n(20,l=R.planes),"planSeleccionado"in R&&n(21,c=R.planSeleccionado)},t.$$.update=()=>{t.$$.dirty[0]&1572865&&console.log("luego de las subscripciones a pacientes, planes y sesiones: sesiones>",o,"pacientes>",a,"planes>",l),t.$$.dirty[0]&7&&(n(2,C=o.find(R=>R.id===b)),console.log(C||"sin seleccion de sesion")),t.$$.dirty[0]&8&&n(6,d=dt(s))},ie(),[o,b,C,s,u,h,d,I,M,x,ce,le,i,r,L,B,V,k,G,a,l,c,ft,Ke,Ne,mn,_t,yn,pt,S,me,he]}class PE extends Rt{constructor(e){super(),Ot(this,e,DE,kE,bt,{sesiones:0,pacientes:19,planes:20,planSeleccionado:21},null,[-1,-1])}}function NE(t){let e,n,s,i,r,o,a,l,c,u,h,d,f;return a=new mE({props:{sesiones:t[2],pacientes:t[3],planes:t[0],optionsPlan:t[1],planSeleccionado:Pc}}),u=new PE({props:{sesiones:t[2],pacientes:t[3],planes:t[0],planSeleccionado:Pc}}),{c(){e=T("body"),n=T("button"),n.textContent="generar backup firestore",s=j(),i=T("div"),r=T("h5"),r.textContent="Listados de Pacientes",o=j(),Ut(a.$$.fragment),l=j(),c=T("div"),Ut(u.$$.fragment),p(i,"class","contenedor-pacientes svelte-1y3ujd1"),p(c,"class","contenedor-sesiones svelte-1y3ujd1"),p(e,"class","svelte-1y3ujd1")},m(g,m){X(g,e,m),v(e,n),v(e,s),v(e,i),v(i,r),v(i,o),It(a,i,null),v(e,l),v(e,c),It(u,c,null),h=!0,d||(f=Z(n,"click",t[4]),d=!0)},p(g,[m]){const w={};m&4&&(w.sesiones=g[2]),m&8&&(w.pacientes=g[3]),m&1&&(w.planes=g[0]),m&2&&(w.optionsPlan=g[1]),a.$set(w);const I={};m&4&&(I.sesiones=g[2]),m&8&&(I.pacientes=g[3]),m&1&&(I.planes=g[0]),u.$set(I)},i(g){h||(We(a.$$.fragment,g),We(u.$$.fragment,g),h=!0)},o(g){rt(a.$$.fragment,g),rt(u.$$.fragment,g),h=!1},d(g){g&&Q(e),At(a),At(u),d=!1,f()}}}let Pc="particular";function OE(t,e,n){let s=[],i=[],r=[],o=[];Fc(()=>{const l=[],c=nt(Ae,"sesiones"),u=nt(Ae,"Pacientes"),h=nt(Ae,"planes"),d=ls(c,Vr("diaSesion")),f=ls(u,Vr("apellido")),g=ls(h,Vr("plan")),m=$r(d,b=>{n(2,s=b.docs.map(C=>({id:C.id,...C.data()})))});console.log("desde onMount CRUDSesiones",s),l.push(m);const w=$r(f,b=>{n(3,i=b.docs.map(C=>({id:C.id,...C.data()})))});l.push(w);const I=$r(g,b=>{n(0,r=b.docs.map(C=>({id:C.id,...C.data()})))});return l.push(I),()=>{l.forEach(b=>b())}});const a=()=>{const l="sesiones"+li().toString()+"BU",c=nt(Ae,l);s.forEach(async g=>{const m=Ct(c);try{await Ur(m,g),console.log("Documento sesion creado exitosamente")}catch(w){console.error("Error al crear el documento sesion:",w)}});const u="planes"+li().toString()+"BU",h=nt(Ae,u);r.forEach(async g=>{const m=Ct(h);try{await Ur(m,g),console.log("Documento plan creado exitosamente")}catch(w){console.error("Error al crear el documento plan:",w)}});const d="Pacientes"+li().toString()+"BU",f=nt(Ae,d);i.forEach(async g=>{const m=Ct(f);try{await Ur(m,g),console.log("Documento paciente creado exitosamente")}catch(w){console.error("Error al crear el documento paciente:",w)}})};return t.$$.update=()=>{t.$$.dirty&3&&(r.length!=0?(console.log(r),n(1,o=r.map(l=>l.plan)),o.push("particular"),o.sort(),console.log(o)):console.log("no hay planes"))},[r,o,s,i,a]}class RE extends Rt{constructor(e){super(),Ot(this,e,OE,NE,bt,{})}}function LE(t){let e,n,s;return n=new RE({}),{c(){e=T("div"),Ut(n.$$.fragment),p(e,"class","contenedorPadre svelte-uueu6x")},m(i,r){X(i,e,r),It(n,e,null),s=!0},p:ye,i(i){s||(We(n.$$.fragment,i),s=!0)},o(i){rt(n.$$.fragment,i),s=!1},d(i){i&&Q(e),At(n)}}}function ME(t){let e,n,s,i,r,o;return{c(){e=T("div"),n=T("h1"),n.textContent="ingrese la contraseña:",s=j(),i=T("input"),p(n,"class","svelte-uueu6x"),p(i,"type","password"),p(i,"class","svelte-uueu6x"),p(e,"class","ingreso svelte-uueu6x")},m(a,l){X(a,e,l),v(e,n),v(e,s),v(e,i),_e(i,t[1]),r||(o=[Z(i,"input",t[3]),Z(i,"input",t[2])],r=!0)},p(a,l){l&2&&i.value!==a[1]&&_e(i,a[1])},i:ye,o:ye,d(a){a&&Q(e),r=!1,tt(o)}}}function xE(t){let e,n,s,i;const r=[ME,LE],o=[];function a(l,c){return l[0]==="nada"?0:l[0]==="Gonzalo"?1:-1}return~(n=a(t))&&(s=o[n]=r[n](t)),{c(){e=T("main"),s&&s.c(),p(e,"class","svelte-uueu6x")},m(l,c){X(l,e,c),~n&&o[n].m(e,null),i=!0},p(l,[c]){let u=n;n=a(l),n===u?~n&&o[n].p(l,c):(s&&(Vc(),rt(o[u],1,1,()=>{o[u]=null}),Uc()),~n?(s=o[n],s?s.p(l,c):(s=o[n]=r[n](l),s.c()),We(s,1),s.m(e,null)):s=null)},i(l){i||(We(s),i=!0)},o(l){rt(s),i=!1},d(l){l&&Q(e),~n&&o[n].d()}}}function FE(t,e,n){let s="Paparula",i="nada",r;const o=()=>{r===s&&n(0,i="Gonzalo")};function a(){r=this.value,n(1,r)}return[i,r,o,a]}class BE extends Rt{constructor(e){super(),Ot(this,e,FE,xE,bt,{})}}new BE({target:document.getElementById("app")});
